<h1 class="timeline__create--title">Edition : <?= htmlspecialchars($params['timeline']->title) ?></h1>
    ...
    <form method="POST" class="timeline__create__form" enctype="multipart/form-data">
        ...
        <div class="timeline__create__form__content">
            <div class="timeline__create__form__content--item">
                ...
                <input type="text" name="title" id="title" value="<?= htmlspecialchars($params['timeline']->title) ?>">
            </div>
            <div class="timeline__create__form__content--date">
                <div class="date__group date__group--start">
                    ...
                    <div class="date__group__item">
                        <input class="form__group__items--input" type="text" name="date_start" id="date_start" value="<?= htmlspecialchars($params['timeline']->date_start) ?>">
                        <div class="date__group__check">
                            <label for="date_start_bc">Avant J.C.</label>
                            <input type="hidden" name="date_start_bc" value="0">
                            <input type="checkbox" name="date_start_bc" id="date_start_bc" value="1" <?= htmlspecialchars(($params['timeline']->date_start_bc === 1) ? "checked" : '') ?>>
                        </div>
                    </div>
                </div>
                <div class="date__group">
                    ...
                    <div class="date__group__item">
                        <input class="form__group__items--input" type="text" name="date_end" id="date_end" value="<?= htmlspecialchars($params['timeline']->date_end) ?>">
                        <div class="date__group__check">
            ...
            <div class="timeline__create__form__content--item">
                ...
                <textarea class="form__group__items--input" name="description" id="description" rows="8"><?= htmlspecialchars($params['timeline']->description) ?></textarea>
            </div>
        </div>
        <div class="timeline__create__form__detail">
            <div class="timeline__create__form__detail__thumbnail">
                <div class="thumbnail__file">
                    <p>Thumbnail</p>
                    <input class="form__group__items--input" type="file" name="thumbnail_file" id="thumbnail_file" value="<?= htmlspecialchars($params['timeline']->thumbnail) ?>" hidden>
                ...
                <div class="thumbnail__preview">
                    <img id="preview" src="<?= htmlspecialchars(IMAGES . "timelines/" . $params['timeline']->thumbnail) ?>" alt="aperçu de l'image uploader" />
                </div>
            </div>
            <input type="hidden" name="thumbnail" id="thumbnail" value="<?= htmlspecialchars($params['timeline']->thumbnail) ?>">
            <input type="hidden" name="thumbnail_alt" id="thumbnail_alt" value="<?= htmlspecialchars($params['timeline']->thumbnail_alt) ?>">
            <input type="hidden" name="user_id" id="user_id" value="<?= htmlspecialchars($params['timeline']->user_id) ?>">
